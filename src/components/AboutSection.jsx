        ...
        <div className="about-container">
          <div className="about-header-row">
            ...
            <div className="royal-style">
              ...
              <p>
                Passionate and results-driven Computer Science undergraduate with hands-on experience in building AI-based systems
                and solving real-world problems through machine learning. Seeking internship opportunities to contribute to impactful
                projects in ML, data science, and AI deployment while gaining industry experience and enhancing technical capabilities.
              </p>
            </div>
          </div>
          ...
          <div className="royal-style">
            <h2>🎓 Education</h2>
            <ul>
              <li><b>Bachelor of Technology</b> – Computer Science And Engineering, Kalasalingam University, 2022–2026</li><br />
